...
$machinestates = array(
	...
	33 => array(
		'name' => 'newBracelet',
		'description' => clienttranslate('${actplayer} must choose a link to start a new bracelet'),
		'descriptionmyturn' => clienttranslate('${you} must choose a link to start a new bracelet'),
		'type' => 'activeplayer',
